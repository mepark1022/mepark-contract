...
| **소스코드** | `App.jsx` (~16,169줄) |
| **최신 커밋** | `f056559` (2026.03.27) |
...
`supabase-setup.sql`, `contracts-table.sql`, `site-management-setup.sql`, `monthly-parking-setup.sql`, `payroll-setup.sql`, `payslip-setup.sql`, `daily-report-setup.sql`, `attendance-setup.sql`, `extra-grouping-setup.sql`, `admin-rpc-functions.sql`, `docs/cashflow-setup.sql`

### 스킬 파일 (skills/)
| 파일 | 용도 |
|------|------|
| `mrpark-contract-skill-v10.md` | 현재 스킬 (v10.0) |
